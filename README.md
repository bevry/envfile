...
``` typescript
import * as pkg from 'https://unpkg.com/envfile@^6.6.0/edition-deno/index.ts'
```
...
``` html
<script type="module">
    import * as pkg from '//cdn.pika.dev/envfile/^6.6.0'
</script>
```
...
``` html
<script type="module">
    import * as pkg from '//unpkg.com/envfile@^6.6.0'
</script>
```
...
``` html
<script type="module">
    import * as pkg from '//dev.jspm.io/envfile@6.6.0'
</script>
```
